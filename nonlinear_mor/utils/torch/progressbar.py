class ProgressBar:
    ...
    def update(self):
        percent = ("{0:." + str(self.decimals) + "f}").format(100 * (self.iteration
                                                                     / float(self.total)))
...
class ProgressTraining:
    ...
    def update(self, training_loss=None, validation_loss=None):
        ...
        if training_loss is None:
            ...
            print('\r{} {}% {}; TL: {:.4E}'.format(self.prefix, percent, self.suffix,
                                                   training_loss), end=self.print_end)
        else:
            print('\r{} {}% {}; TL: {:.4E}; VL: {:.4E}'.format(self.prefix, percent, self.suffix,
